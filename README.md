# Hi, I'm Carter! <img src="https://github.com/TheDudeThatCode/TheDudeThatCode/blob/master/Assets/Hi.gif" width="35" />
  ### Connect with me:
<p align="center">
  <a href="https://www.linkedin.com/in/carter-rudolph">
    <img src="https://skillicons.dev/icons?i=linkedin" height="60" style="display:inline-block;" />
  </a>
  <a href="https://discordapp.com/users/1344467840777977957">
    <img src="https://skillicons.dev/icons?i=discord" height="60" style="display:inline-block;" />
  </a>
  <a href="mailto:cartergeorge2005@gmail.com">
    <img src="https://skillicons.dev/icons?i=gmail" height="60" style="display:inline-block;" />
  </a>
</p>
...
A mobile platform for student organizations to manage roles with custom permissions, shared calendars, file archives, role-specific push notifications, and an AI chat assistant powered by an MCP server and a RAG pipeline to query files and create events or tasks running in a containerized AWS environment.
...
A serverless image recognition and management app built to mirror a professional production environment. Users upload images that are auto-tagged via Amazon Rekognition, with tags stored in DynamoDB for browsing, filtering, and search. Built with full user authentication access throughout with AWS Cognito and AWS Amplify.
...
### **ACM Chapter Website** *(In Development)*
Official ACM chapter website rebuilt by a 15-member team with an open-source workflow. Developed full UI design blueprints and engineering the backlog into prioritized, component-level development tasks.
...
|---------|---------|------|
| [Full-Stack Canvas Clone](https://github.com/CarterRudolph2005/Canvas-cop4870) | A full-stack LMS built with MVVM on the frontend and a Controller/Service/Repository backend, connected to a PostgreSQL database via RESTful APIs with Gmail SMTP email notifications. | ![.NET](https://img.shields.io/badge/.NET-512BD4?style=flat-square&logo=dotnet&logoColor=white) ![MAUI](https://img.shields.io/badge/MAUI-512BD4?style=flat-square&logo=dotnet&logoColor=white) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![Gmail SMTP](https://img.shields.io/badge/Gmail_SMTP-EA4335?style=flat-square&logo=gmail&logoColor=white) |
| [Movie Discovery App](https://github.com/CarterRudolph2005/Movie-Discovery-Web-Application/tree/main) | An interactive movie browser powered by the TMDB API, rendering relevant results dynamically with a responsive UI. | ![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black) ![Tailwind](https://img.shields.io/badge/Tailwind-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white) |
| [AI Chatbot](https://github.com/CarterRudolph2005/Python_UVAI) | A lightweight Python chatbot exploring OpenAI API integration via tools from UV, a modern Python package manager. An intro to embedding AI into real applications. | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) |
| [Bookstore POS Simulation](https://github.com/CarterRudolph2005/Bookstore-POS) | A C++ Bookstore Inventory Manager demonstrating OOP with dynamic arrays, book tracking, and simulated retail operations including sales and register management. | ![C++](https://img.shields.io/badge/C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) |
| [CollegeCooking](https://github.com/CarterRudolph2005/CollegeCooking) | A recipe discovery site designed for college students, with flexible ingredient lists and an approachable UI built from scratch. | ![HTML](https://img.shields.io/badge/HTML-E34F26?style=flat-square&logo=html5&logoColor=white) ![CSS](https://img.shields.io/badge/CSS-1572B6?style=flat-square&logo=css3&logoColor=white) |
